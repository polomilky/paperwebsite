...
(function(E, X) { typeof module === "object" && module.exports ? module.exports = E.document ? X(E) : X : E.Highcharts = X(E) })(typeof window !== "undefined" ? window : this, function(E) {
    ...
    B.stop = Oa;
    N = {
        colors: "#F59AF0,#55E9BC,#FAD662,#BA53DE,#FA5555,#f15c80,#e4d354,#2b908f,#f45b5b,#91e8e1".split(","),
        ...
        plotOptions: {
            line: {
                ...
                dataLabels: {
                    ...
                    style: { color: "contrast", fontSize: "16px", fontWeight: "bold" },
        ...
        tooltip: {
            ...
            shadow: !0,
            snap: Mb ? 25 : 10,
            style: { color: "#333333", cursor: "default", fontSize: "18px", padding: "8px", pointerEvents: "none", whiteSpace: "nowrap" }
        },
    ...
    Ca.prototype = {
        ...
        getStyle: function(a) {
            return this.style = u({ fontFamily: '"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif', fontSize: "18px" }, a) },
        isHidden: function() {
    ...
    ka.prototype = {
        defaultOptions: {
            ...
            //xy軸文字
            labels: { enabled: !0, style: { color: "#fff", cursor: "default", fontSize: "16px" }, x: 0, y: 15 },
            lineColor: "#C0D0E0",
            lineWidth: 1,
            minPadding: 0.01,
            maxPadding: 0.01,
